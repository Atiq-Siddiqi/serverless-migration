...
An enterprise reference architecture demonstrating zero-downtime application modernization using the **Strangler Fig Pattern**. Designed event-driven microservice prototypes using AWS Lambda, API Gateway, and Amazon ECS to benchmark zero-downtime cutovers, improving simulated developer velocity and deployment efficiency.
